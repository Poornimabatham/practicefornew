                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            date = new Date(val.AttendanceDate);
                                            data["attendanceDate"] = moment(date).format("YYYY/MM/DD");
                                            date2 = new Date(val.RegularizeRequestDate);
                                            ...
                                            if (!(regsts == 3)) return [3 /*break*/, 6];
                                            if (approverid != 0) {
                                                pendingapprover = val.ApproverId;
                                            }
                                            if (!(pendingapprover == undefined)) return [3 /*break*/, 3];
