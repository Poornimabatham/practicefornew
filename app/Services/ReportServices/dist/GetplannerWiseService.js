                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        result.forEach(function (val) { return __awaiter(_this, void 0, void 0, function () {
                            var data, datetimeString, datetimeString2, dateTime1, Time1, dateTime, Time2, Interval, startDateTime, endDateTime, time, subtimeLoggedhours, halfInSeconds, halfvalue, hours, minutes, secs, timeString;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        data = {};
