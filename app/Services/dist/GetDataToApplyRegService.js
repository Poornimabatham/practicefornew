...
var GetDataToRegService = /** @class */ (function () {
    ...
    GetDataToRegService.FetchingdatatoReg = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var count, status, currentMonth, currentmonth, MinTimes, MaxDays, Regularizecount, regularizationsettingsts, selectRegularizationSettings, row, regularizeCount, affected_rows, query, attendanceData, attendancearr, result, monthDate, formattedMonth;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (data.month != "null" || data.month != undefined) {
                            currentmonth = moment_1["default"](data.month).format("YYYY-MM-DD");
                        }
                        MinTimes = "";
                        MaxDays = 0;
                        Regularizecount = 0;
