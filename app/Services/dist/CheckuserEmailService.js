...
var CheckUserEmailService = /** @class */ (function () {
    ...
    CheckUserEmailService.sendSignUpMail = function (getparam) {
        return __awaiter(this, void 0, void 0, function () {
            var app, username, password, loginResp, phone, tmp, orgid, empId, logo, subject, querytest, namebody, message, maillink, mailbtnlink, unsubscribe_link, headers, querytest2, namebody2, message1, platFormName, subject1, headers1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        app = getparam.appName ? getparam.appName : "";
                        username = getparam.userName ? getparam.userName : "";
                        password = getparam.password ? getparam.password : "";
                        loginResp = getparam.response ? getparam.response : "";
                        phone = getparam.phone ? getparam.phone : 0;
                        tmp = JSON.parse(loginResp);
                        orgid = tmp.OrganizationId;
                        return [4 /*yield*/, Helper_1["default"].encode5t(tmp.EmployeeId.toString())];
                    case 1:
                        empId = _a.sent();
                    ...
                    case 2:
                        ...
                        message = namebody;
                        maillink = '<a href="http://ubiattendance.ubihrm.com/index.php/services/activateAccount?iuser=' +
                            empId +
                            '" style="color: #FF7D33;">Verify your Account</a> ';
                        mailbtnlink = '<a href="http://ubiattendance.ubihrm.com/index.php/services/activateAccount?iuser=' +
                            empId +
                            '" style="font-family: georgia, Arial, sans-serif;font-size: 15px;text-align: justify;color: rgb(255, 255, 255);text-decoration: none;background-color: rgb(37, 182, 153);border-color: rgb(248, 249, 250);padding: 15px;font-weight: 700 !important;">Verify your Account</a>';
                        unsubscribe_link = '<a href="' +
                            "URL" +
                            "cron/unsubscribeOrgMails/" +
                            orgid +
                            '" target="_top">unsubscribe </a>';
                        ...
                        return [4 /*yield*/, Helper_1["default"].sendEmail(tmp.orgmail, subject, message, headers)];
                    case 3:
                        // await Helper.sendEmail("meghwalshivam18@gmail.com",subject + "testMail",message,headers);
                        _a.sent();
                        return [4 /*yield*/, Database_1["default"].from("All_mailers")
                    ...
                    case 4:
                        ...
                        message1 = namebody2;
                        platFormName = app == "ubiAttendance" ? "ubiAttendance" : "ubiSales";
                        subject1 = "Please share the circular to the Employees for starting with " +
                            platFormName;
                        headers1 = "From: <noreply@ubiattendance.com>" + "\r\n";
                        ...
                        return [4 /*yield*/, Helper_1["default"].sendEmail(tmp.orgmail, subject1, message1, headers1)];
                    case 5:
                        // await Helper.sendEmail("meghwalshivam18@gmail.com",subject1 + "testMail",message1,headers1);
                        _a.sent();
                        return [2 /*return*/];
