...
var LateComingService = /** @class */ (function () {
    ...
    LateComingService.getLateComing = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var Begin, limit, lateComersList, zone, currentDateTimeIn, Date2, adminStatus, condition, deptId, res, Output;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        lateComersList = Database_1["default"].from("AttendanceMaster as A")
                            ...
                            .select("E.FirstName", "E.LastName", "A.TimeIn as atimein", "A.ShiftId", "A.EmployeeId", Database_1["default"].raw("(SELECT TIMEDIFF(A.TimeIn, CASE WHEN S.TimeInGrace != '00:00:00' THEN S.TimeInGrace ELSE S.TimeIn END)) as latehours"), Database_1["default"].raw("A.TimeIn > (CASE WHEN S.TimeInGrace != '00:00:00' THEN S.TimeInGrace ELSE S.TimeIn END)\n    AND TIMEDIFF(A.TimeIn, CASE WHEN S.TimeInGrace != '00:00:00' THEN S.TimeInGrace ELSE S.TimeIn END) > '00:00:59' as l"), Database_1["default"].raw("SUBSTRING_INDEX(EntryImage, '.com/', -1) AS EntryImage"))
