...
var getProfileImageService = /** @class */ (function () {
    ...
    getProfileImageService.generateNumericOTP = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var EmailId, Empid, Orgid, fName, lName, name, EncodeEmailForCheck, data2, resresultOTP, nameQuery, Count, n, generator, result, i, randomIndex, message, headers, subject, mailresponse, selectEmailOtp_Auth, affected_rows, updateEmaiOTPEmail, insertEmailOtp_Authentication;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
