...
var DesignationService = /** @class */ (function () {
    ...
    DesignationService.getDesignation = function (a) {
        return __awaiter(this, void 0, void 0, function () {
            var begin, designationList, result, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.getDesignationesignationList];
                }
            });
        });
    };
    DesignationService.updateDesignation = function (c) {
        return __awaiter(this, void 0, void 0, function () {
            var result, curdate, designationList, Result, r, designationList2, name, sts1, res, updateDesignaion, count, timezone, defaulttimeZone, dateTime, formattedDate, module, appModule, actionperformed, activityBy, getempname, insertActivityHistoryMaster;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = [];
