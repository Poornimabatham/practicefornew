...
var DesignationService = /** @class */ (function () {
    ...
    DesignationService.AddDesignation = function (a) {
        return __awaiter(this, void 0, void 0, function () {
            var currentDate, designationList, result, affectedRows, insertDesignation, affectedRows2, timezone, defaulttimeZone, dateTime, formattedDate, module, appModule, activityby, actionPerformed, actionperformed2, query2;
    ...
    DesignationService.getDesignation = function (a) {
        return __awaiter(this, void 0, void 0, function () {
            var begin, designationList, currentDate, result, s, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        begin = (a.currentpage - 1) * a.perpage;
                        designationList = Database_1["default"].from("DesignationMaster")
                        ...
                        currentDate = new Date();
                        return [4 /*yield*/, designationList];
                    case 1:
                        result = _a.sent();
                        s = [];
                        res = 0;
                        ...
                        return [2 /*return*/, designationList];
                }
            });
        });
    };
    DesignationService.updateDesignation = function (c) {
        return __awaiter(this, void 0, void 0, function () {
            var result, curdate, designationList, Result, r, designationList2, name, sts1, qr, count3, res, updateDesignaion, count, timezone, defaulttimeZone, dateTime, formattedDate, module, appModule, actionperformed, activityBy, getempname, activityby, insertctivityHistoryMaster;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = [];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Database_1["default"].from("DesignationMaster")
                                ...
                                .where("Id", c.Updateid)];
                    case 3:
                        designationList2 = _a.sent();
                        name = "";
                        sts1 = "";
                        return [4 /*yield*/, designationList2];
                    case 4:
                        qr = _a.sent();
                        count3 = designationList2.length;
                        res = "";
                    ...
                    case 9:
                        insertctivityHistoryMaster = _a.sent();
